...
def build_controllerUI():
	...
	exp_startpoint = tk.Button(btn_frm,text="Go To Start Point", width=20,command=lambda:ExperimentStartPoint()) #probably want to change text
	exp_startpoint.grid(row=11,column=1, padx=5, pady=5)
